/**
 * Functions Services - Application Layer Export
 *
...
/**
 * Functions Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for functions domain.
 */

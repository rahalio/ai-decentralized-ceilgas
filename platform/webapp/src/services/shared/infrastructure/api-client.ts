 ...
 *
 * Always sends X-API-Key (demo default: ceilgas_demo_local_dev_key).
...
const DEFAULT_API_KEY = "ceilgas_demo_local_dev_key";
...
const g = globalThis as typeof globalThis & {
  __ceilgasApiClient?: ApiClient;
};

/** HMR-stable singleton — reuse the same instance across Vite hot updates. */
export const apiClient: ApiClient = g.__ceilgasApiClient ?? new ApiClient();

g.__ceilgasApiClient = apiClient;
